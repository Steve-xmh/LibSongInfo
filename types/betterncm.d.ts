...
declare module "plugin" {
	...
	export interface LibSongInfoPlugin extends NCMPlugin {
        playProgress: number;
        loadProgress: number;
		duration: number;
		playState: number;
	...
	export class NCMInjectPlugin extends EventTarget {
		...
		mainPlugin: LibSongInfoPlugin;
		loadError: Error | null;
		finished: boolean;
		constructor(mainPlugin: LibSongInfoPlugin, filePath: string);
		onLoad(fn: (selfPlugin: NCMInjectPlugin, evt: CustomEvent) => void): void;
